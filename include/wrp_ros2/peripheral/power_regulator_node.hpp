...
// ROS Messages
#include "wrp_ros2/msg/power_regulator_channel_state.hpp"
#include "wrp_ros2/msg/power_regulator_device_state.hpp"
#include "wrp_ros2/srv/power_regulator_control.hpp"
...
class PowerRegulatorNode : public rclcpp::Node {
 ...
 private:
  ...
  // ----- Published Messages-----
  wrp_ros2::msg::PowerRegulatorDeviceState device_state_;
  // ----- Subscribers & Publishers & Services -----
  rclcpp::Publisher<wrp_ros2::msg::PowerRegulatorDeviceState>::SharedPtr
      device_state_publisher_;

  rclcpp::Service<wrp_ros2::srv::PowerRegulatorControl>::SharedPtr
